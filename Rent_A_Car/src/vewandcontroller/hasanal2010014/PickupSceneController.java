 ...
 * @author siam
 */
public class PickupSceneController implements Initializable ,vehicleController{

    @FXML
    private TextField cabinSizeTextField;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle rb) {
      ...
      public void vehicleData(Vehicle v){
         if(!cabinSizeTextField.getText().isBlank()){
            ...
            Float.parseFloat(cabinSizeTextField.getText()), null, null);
